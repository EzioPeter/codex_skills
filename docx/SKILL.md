...
**Use precise direct file edits for string replacement. Do not write Python scripts.** Scripts introduce unnecessary complexity. Direct edits keep the replacement target explicit and reliable.
